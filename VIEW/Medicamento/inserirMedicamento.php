    ...
    <div class="container blue lighten-4 black-text col s12"> <!-- Conteiner / Cor da tabela / col s12 -> tamanho a tabela -->
        ...
        <div class="row">
            <form action="insertMedicamento.php" method="POST" id="Medico" class="col s12">
                ...
                <div class="input-field col s8">
                    <input id="validade" type="date" name="txtValidade">
                    <label for="validade" class="black-text bold">DATA DE VALIDADE</label>
                </div>

                <div class="input-field col s8">
                    <input id="qtde" type="text" name="txtQtde">
                    <label for="qtde" class="black-text bold">QUANTIDADE</label>
                </div>

                <div class="input-field col s8">
                    <input id="unidade" type="text" name="txtUnidade">
